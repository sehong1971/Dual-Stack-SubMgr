...
func (o *GetHealthReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /health] get_health", response, response.Code())
	}
}
...
type GetHealthOK struct {
	Payload *rtmgr_models.HealthStatus
}
